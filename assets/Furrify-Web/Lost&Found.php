...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO lost_pets (pet_name, location, pet_age, category, gender, vaccination, contact, pet_color, breed, description, photo)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssissssssss", $pet_name, $location, $pet_age, $category, $gender, $vaccination, $contact, $pet_color, $breed, $description, $imageData);
                    ...
                    <div class="col-md-3 col-lg-4">
                        ...
                        <div class="container23">
                                <div class="pet-details">
                                    ...
                                    <h5>Location:<br><?php echo $row['location']; ?></h5>
                                    <br>
                                    <div class="item-dtls">
