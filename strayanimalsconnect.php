    ...
    <a href="" class="navbar-brand p-0">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a href="index.php" class="nav-item nav-link  text-black">Home</a>
                ...
                <a href="strayanimalsconnect.php" class="nav-item active nav-link text-black">SAC</a>
...
require 'assets\Furrify-Web\phpmailer\PHPMailer.php';
require 'assets\Furrify-Web\phpmailer\SMTP.php';
require 'assets\Furrify-Web\phpmailer\Exception.php';
